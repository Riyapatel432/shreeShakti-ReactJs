...
const handleFieldChange = (fieldName, rawValue) => {
  ...
  setForm((prev) => {
    ...
    if (fieldName === "product") {
      ...
      updated.moc = selectedProduct?.moc?._id || "";
    }
    ...
    <Box>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Breadcrumbs separator={<NavIcon fontSize="small" />}>
          ...
          <Typography color="warning.main">Product Prices</Typography>
        </Breadcrumbs>
      </Box>
...
/>
  ...
  title={isEdit ? "Edit Product Price" : "Add New Product Price"}
...
<Grid size={{ xs: 12, md: 4 }}>
  <TextField
    ...
    onChange={(e) => {
      ...
      handleFieldChange("current_price", value);
    }}
    slotProps={{
    htmlInput: {
      min: 0,
...
<Grid size={{ xs: 12, md: 4 }}>
  <LocalizationProvider dateAdapter={AdapterDayjs}>
    <DatePicker
      ...
      onChange={(value) => {
        if (!value) {
          handleFieldChange("effective_date", "");
          return;
        }
        ...
        if (value.day() !== 1) {
          setErrors((prev) => ({
            ...prev,
            effective_date: "Please select only Monday.",
          }));
          return;
        }
